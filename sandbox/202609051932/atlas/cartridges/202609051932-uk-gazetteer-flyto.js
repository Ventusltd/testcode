...
(() => {
  ...
  async function queryPipelineIdentity(ref) {
  ...
  async function receiveExactRepdDeepLink(input, resultsEl,
    ...
    try {
      ...
      input.value = repdRef;
      const snapshot = await queryPipelineIdentity(repdRef);
      ...
      state.deep_link = {
        ...
        location_provenance: exact.location_provenance || null,
        identity_source: exact.identity_source || 'OFFICIAL_ACTIVE_REGISTER',
