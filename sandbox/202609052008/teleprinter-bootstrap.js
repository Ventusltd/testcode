...
try {
  ...
  if (pin.generation !== '202609052008' || pin.app !== 'landing' || !/^[a-f0-9]{40}$/.test(pin.commit) || pin.repository !== 'https://github.com/Ventusltd/testcode') throw new Error('The source code version could not be checked.');
