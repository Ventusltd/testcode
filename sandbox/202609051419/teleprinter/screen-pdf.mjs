...
export async function screenPdf({ width, height, rgba }) {
  ...
  const objects = [
    ...
    stream(`/Type /XObject /Subtype /Image /Width ${width} /Height ${height} /ColorSpace /DeviceRGB /BitsPerComponent 8 /Interpolate false /Filter /FlateDecode${transparent ? ' /SMask 6 0 R' : ''}`, await deflate(rgb)),
