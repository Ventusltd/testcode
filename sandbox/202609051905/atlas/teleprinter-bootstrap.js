...
mountToolLayers([{"id":"gis-sld-financial-sandbox","title":"GIS SLD Financial Sandbox","entry":"../layer-apps/solar-bess-topology-v7/gis-sld-financial-sandbox/index.html"},{"id":"module-layout","title":"Module Layout","entry":"../layer-apps/solar-bess-topology-v7/module-layout/index.html"}], import.meta.url);
...
try {
  ...
  if (pin.generation !== '202609051905' || pin.app !== 'atlas' || !/^[a-f0-9]{40}$/.test(pin.commit) || pin.repository !== 'https://github.com/Ventusltd/testcode') throw new Error('The source code version could not be checked.');
