...
(function gridAtlasMenuBar() {
  ...
  function install(doc) {
    ...
    /* The search bar is NOT moved. It is the one control a person needs before
       they know which menu to open, and File is closed on arrival -- so moving
       it here left it alive but measuring 0x0, which reads as "the address
       search bar disappears". Same fault the masthead comment below records:
       an always-needed node parked in a collapsed panel. It stays in
       .map-container, where every earlier published version kept it. */
