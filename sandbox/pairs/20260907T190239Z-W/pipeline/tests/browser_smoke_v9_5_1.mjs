...
const baseUrl = process.env.V9_BASE_URL || "http://127.0.0.1:8765/uk_renewables_pipeline/v9.5.1/";
...
try {
  ...
  console.log("V9.5.1 browser smoke: PASS (133 ALL, 45 RELEVANT, Beacon Fen REPD 13599, date sort, CSV and Atlas)");
} finally {
  await browser.close();
}
