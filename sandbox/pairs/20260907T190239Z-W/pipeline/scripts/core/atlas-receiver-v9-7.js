...
/* PAIR GG2050-PAIR-20260907T141211Z-W: the contract is the pair-local copy under ../../../atlas/deeplink/, so this
 * candidate's links reach this candidate's Atlas and nothing outside the pair. Routes in that
 * file are relative to it and are resolved against RECEIVERS_URL below. */
const RECEIVERS_URL = new URL("../../../atlas/deeplink/receivers.json", import.meta.url).href;
...
const COMPILED_CONTRACT = Object.freeze({
  ...
  canonical: Object.freeze({
    id: "gridatlas-v9",
    route: new URL("../../../atlas/", import.meta.url).href,
    carries_engine: true,
  }),
...
export function primeAtlasReceiverV9_7(document_) {
  ...
  const route = document_.canonical && document_.canonical.route && new URL(document_.canonical.route, RECEIVERS_URL).href;
  if (!route) {
