...
function mapActionHtmlV9_5_1(project) {
  ...
  if (String(project.repd_ref) === '10919') return `<a class="action-link atlaslink" target="_blank" rel="noopener" href="${escapeHtml(href)}">MAP &#8599;</a><div class="map-note">Approximate Crown Estate lease-area centre; indicative grid distances.</div>`;
