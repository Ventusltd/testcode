...
import {compact,proveEquivalent,replaceMapEngine} from './token-compaction.mjs';
...
const assembled=replaceMapEngine(parent.toString(),engine.toString(),module.toString());assert.equal(hash(assembled),p.assembledSha256);
